...
function DashboardContent() {
    ...
    const [userID, setUserId] = React.useState(12345);
    const [username, setUsername] = React.useState("Teacher_Goals");
    const toggleDrawer = () => {
        setOpen(!open);
    };
...
export default function StudentDetails() { return <DashboardContent />; }